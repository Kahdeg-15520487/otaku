...
from otaku2.settings.migrations.prompt_texts import (
    EXTRACT_0_2_2,
    refresh_template,
    update_prompts,
)
from otaku2.settings.migrations.providers_file import (
    ensure_providers,
    move_providers,
    seal_api_keys,
)
from otaku2.settings.migrations.surgery import (
    Migration,
    apply_migrations,
    drop_key_everywhere,
    ensure_section,
