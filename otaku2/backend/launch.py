...
from otaku2.backend.api import transfer
from otaku2.backend.paths import Paths
from otaku2.backend.session import NO_MODEL_HINT, Session
from otaku2.encryption import AskSecret, Cipher, EncryptionError, SealedError
from otaku2.formatting import pretty_path
from otaku2.logging import ErrorLog, RequestLog, SystemLog
from otaku2.providers import ProviderConfig, Registry, autoconfigure_providers
from otaku2.settings import config as config_file
from otaku2.settings import migrations, write_atomic
from otaku2.settings import prompts as prompts_file
from otaku2.settings import providers as providers_file
from otaku2.settings import state as state_file
from otaku2.settings.config import Config
from otaku2.store import Store, is_encrypted
from otaku2.worker import Worker
...
def _seed_sample(session: Session) -> None:
    ...
    package = Path(__file__).parent.parent  # otaku2/ (named otaku once installed)
