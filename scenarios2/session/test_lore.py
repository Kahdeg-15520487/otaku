...
from otaku2.backend.formats import exports, imports
...
from scenarios2.support.harness import App, launch, set_config
from scenarios2.support.screens import CTRL_S, DOWN, ENTER, ESC, TAB, run_screen
from scenarios2.support.server import numbered_script
...
class TestFailedPass:
    ...
    def test_an_unexpected_crash_is_logged_not_swallowed(
        ...
        monkeypatch.setattr("otaku2.worker.Extractor", Exploding)
