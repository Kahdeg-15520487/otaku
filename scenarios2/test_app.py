...
from otaku2 import encryption
from otaku2.backend import launch as backend_launch
from otaku2.backend.paths import Paths
from otaku2.encryption import EncryptionError, PlainCipher
from otaku2.formatting import toml_string
from otaku2.settings import config as config_mod
from otaku2.settings import prompts as prompts_mod
from otaku2.settings import providers as providers_mod
from otaku2.settings.migrations import surgery
from otaku2.settings.migrations.prompt_texts import EXTRACT_0_2_2
from otaku2.store import DatabaseError, Store, is_encrypted
from otaku2.store import migrations as store_migrations
from otaku2.store.database import check_value
from otaku2.store.migrations import v2 as store_v2
from otaku2.store.migrations import v3 as store_v3
from otaku2.store.schema import SCHEMA_DDL
from otaku2.terminal.tty import BOLD, RESET
from scenarios2.support import server as scripted
from scenarios2.support.harness import App, launch, run_otaku, set_config
from scenarios2.support.server import ModelServer
...
class TestResume:
    ...
    def test_a_remembered_model_of_a_deleted_provider_reports_and_skips(
        self, app: App
    ) -> None:
