...
from otaku.terminal.theme import _CURRENT, DARK, LIGHT, Color, Theme, color, theme, use
...
def _config(*, dialogue_color: str = "auto", dialogue_bold: bool = False) -> Config:
    return Config(providers={}, dialogue_color=dialogue_color, dialogue_bold=dialogue_bold)
